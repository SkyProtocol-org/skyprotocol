...
== Criteria 1.a: Maintenance of Unique Identifiable Contract State
...
* We will use reference inputs to allow contracts to read the root
  hash.

== Criteria 1.b: Multisig for Data Availability Committee
...
== Criteria 1.c: Merkle Proof of Data Availability
